                  ...
                  <div class="card bg-primary text-white rounded-0 border-0">
                    <div class="card-body">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nroanular" v-model="nroanular"></div>
...
export default{
  ...
  methods: {
    ...
    crearFactura() {
      const url = 'https://py-kc-rest-v1-xkqvciodha-rj.a.run.app/oper/facturacion/crear?proveedorKey=T1-N392010028-S0-P1&codigoSector=17';
